...
export class Header {
	...
	private renderContentTypeToggle(container: HTMLElement): void {
		...
		// Video button (currently the only implemented type)
		...
		// Book button (disabled for now - future feature)
		const bookButton = contentTypeToggle.createEl("button", {
			cls: "library-content-toggle disabled",
			text: "كتب",
			attr: {
